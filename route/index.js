...
router.post(`${version}/create_post/:id`, userController.create_post)
router.delete(`${version}/delete_user/:id`, userController.delete_user)
router.delete(`${version}/delete_post/:id/:id_post`, userController.delete_post)
